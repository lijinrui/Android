package com.example.jinrui.android_helloworld.feature;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private void initSpeech() {
        ...
        SpeechUtility. createUtility( this, SpeechConstant. APPID + "=5aaa59d1" );
    }

    @Override
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btn_startspeech) {
            startSpeechDialog();

        } else if (i == R.id.btn_startspeektext) {
            speekText();
